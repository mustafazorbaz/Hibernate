...
public class Personel {
	...
	@OneToMany //1-m birden çok baðlantý
	
	 //NOT:Bunlarý yazmaya bilirdikte eðer yazmasaydýk isimleri varsayýlan olarak küçük olurdu
	//Ýki Entitiy kalýlýtým tablosunun adý
	@JoinTable(			
